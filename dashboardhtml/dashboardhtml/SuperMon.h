...
<title>Web Page Update Demo</title>
  ...
  <body style="background-color: #efefef" onload="process()">
    ...
    <main class="container" style="margin-top:70px">
      ...
      <col span="2"style="background-color:rgb(0,0,0); color:#FFFFFF">
      <tr>
        <th colspan="1"><div class="heading">Puerto</div></th>
        <th colspan="1"><div class="heading">Estado</div></th>
      </tr>
      <tr>
        <td><div class="bodytext">Parqueo 1</div></td>
        <td><div class="tabledata" id = "b0"></div></td>
      </tr>
      <tr>
        <td><div class="bodytext">Parqueo 2</div></td>
        <td><div class="tabledata" id = "b1"></div></td>
      </tr>
      <tr>
        <td><div class="bodytext">Parqueo 3</div></td>
    ...
    <br>
    <div class="bodytext">Reconocimiento </div>
    <button type="button" class = "btn" id = "btn0" onclick="ButtonPress0()">Identificado</button>
    </div>
    <br>
    <br
    <br>
  ...
  <footer div class="foot" id = "temp" >Team ANPR UNI ABET</div></footer>
